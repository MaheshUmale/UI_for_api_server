...
# Mock Brain components for integration if not found
class MockBrain:
    def __init__(self, **kwargs): pass
    async def start(self): pass
    def stop(self): pass
    async def submit_candle(self, candle, option_chain): pass
    async def get_signal(self): return None

class MockStrategyEngine: pass
class MockBayesianMemory: pass
class MockCandle:
    def __init__(self, **kwargs): pass

Brain = MockBrain
StrategyEngine = MockStrategyEngine
BayesianMemory = MockBayesianMemory
Candle = MockCandle
