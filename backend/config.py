...
try:
    ...
    TV_COOKIE = browser_cookie3.brave(domain_name='tradingview.com')
    print("TradingView cookies loaded via browser-cookie3 (Brave)")
except Exception as e:
    # Fallback to env var string if browser-cookie3 fails or isn't needed
    pass
